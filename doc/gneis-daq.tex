...
Версия: \GDVER \\
Ревизия документа: 0.1 (февраль 2019)}
...
Вспышка продолжается до сэмпла с номером $(i + l - 1)$ включительно. Дальнейший поиск вспышек продолжается с сэмпла с номером $(i + l)$.
